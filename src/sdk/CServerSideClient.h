/**
 * The code was provided from CS2Fixes maintained by Source2ZE.
 * Commit: https://github.com/Source2ZE/CS2Fixes/blob/d2e329461f5a9e628462b4ac00a2167e060a51d0/src/cs2_sdk/serversideclient.h
 */

#ifndef _serversideclient_h
#define _serversideclient_h
...
public:
    ...
    virtual bool ExecuteStringCommand(const CNETMsg_StringCmd& msg) = 0; // "false" trigger an anti spam counter to kick a client.
...
public: // Message Handlers
    ...
    virtual bool ProcessStringCmd(const CNETMsg_StringCmd& msg) = 0;
...
public:
    virtual bool ProcessSpawnGroup_LoadCompleted(const CNETMsg_SpawnGroup_LoadCompleted& msg) = 0;
    virtual bool ProcessClientInfo(const CCLCMsg_ClientInfo& msg) = 0;
    virtual bool ProcessBaselineAck(const CCLCMsg_BaselineAck& msg) = 0;
    virtual bool ProcessLoadingProgress(const CCLCMsg_LoadingProgress& msg) = 0;
    virtual bool ProcessSplitPlayerConnect(const CCLCMsg_SplitPlayerConnect& msg) = 0;
    virtual bool ProcessSplitPlayerDisconnect(const CCLCMsg_SplitPlayerDisconnect& msg) = 0;
    virtual bool ProcessCmdKeyValues(const CCLCMsg_CmdKeyValues& msg) = 0;
...
public:
    ...
    virtual bool ProcessConnectionClosed(const NetMessageConnectionClosed& msg) = 0;
    virtual bool ProcessConnectionCrashed(const NetMessageConnectionCrashed& msg) = 0;

public:
    virtual bool ProcessChangeSplitscreenUser(const NetMessageSplitscreenUserChanged& msg) = 0;
